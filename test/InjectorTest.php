...
class InjectorTest extends TestCase
{
    ...
    public function testMakeInstanceUsesReflectionForUnknownParamsInMultiBuildWithDepsAndVariadics(): void
    {
        ...
        $injector = new Injector;
        $obj = $injector->make(NoTypehintNoDefaultConstructorVariadicClass::class,
            array('val1'=>TestDependency::class)
        );
    ...
    public function testMakeInstanceUsesReflectionForUnknownParamsWithDepsAndVariadicsWithTypeHint(): void
    {
        ...
        $injector = new Injector;
        $obj = $injector->make(TypehintNoDefaultConstructorVariadicClass::class,
    ...
    public static function provideExecutionExpectations(): array
    {
        ...
        $toInvoke = testExecuteFunction::class;
        $args = array();
        $expectedResult = 42;
        $return[] = array($toInvoke, $args, $expectedResult);
        ...
        $toInvoke = testExecuteFunctionWithArg::class;
        $args = array();
        $expectedResult = 42;
        $return[] = array($toInvoke, $args, $expectedResult);
        ...
        if (PHP_VERSION_ID > 50400) {
            ...
            $object = new \Auryn\ReturnsCallable('new value');
            $args = array();
    ...
    {
        $injector = new Injector();
        $injector->delegate(TestDelegationSimple::class, createTestDelegationSimple::class);
    ...
    public function testPrepareCallableReplacesObjectWithReturnValueOfSameInterfaceType(): void
    {
        ...
        $injector->prepare("Auryn\SomeInterface", function ($impl) use ($expected) {
            return $expected;
        });
        $actual = $injector->make("Auryn\SomeImplementation");
    ...
    public function testPrepareCallableReplacesObjectWithReturnValueOfSameClassType(): void
    {
        $injector = new Injector;
        $expected = new SomeImplementation; // <-- implements SomeInterface
        $injector->prepare("Auryn\SomeImplementation", function ($impl) use ($expected) {
            return $expected;
        });
        $actual = $injector->make("Auryn\SomeImplementation");
        $this->assertSame($expected, $actual);
