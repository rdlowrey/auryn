...
ZEPHIR_INIT_CLASS(Auryn_CachingReflector) {
	...
	ZEPHIR_REGISTER_CLASS(Auryn, CachingReflector, auryn, cachingreflector, auryn_cachingreflector_method_entry, 0);

	zend_declare_property_null(auryn_cachingreflector_ce, SL("reflector"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(auryn_cachingreflector_ce, SL("cache"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_class_constant_string(auryn_cachingreflector_ce, SL("CACHE_KEY_CLASSES"), "auryn.refls.classes." TSRMLS_CC);

	zend_declare_class_constant_string(auryn_cachingreflector_ce, SL("CACHE_KEY_CTORS"), "auryn.refls.ctors." TSRMLS_CC);

	zend_declare_class_constant_string(auryn_cachingreflector_ce, SL("CACHE_KEY_CTOR_PARAMS"), "auryn.refls.ctor-params." TSRMLS_CC);

	zend_declare_class_constant_string(auryn_cachingreflector_ce, SL("CACHE_KEY_FUNCS"), "auryn.refls.funcs." TSRMLS_CC);

	zend_declare_class_constant_string(auryn_cachingreflector_ce, SL("CACHE_KEY_METHODS"), "auryn.refls.methods." TSRMLS_CC);

	zend_class_implements(auryn_cachingreflector_ce TSRMLS_CC, 1, auryn_reflectorinterface_ce);
	return SUCCESS;
